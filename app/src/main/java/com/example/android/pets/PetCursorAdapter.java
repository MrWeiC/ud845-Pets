...
public class PetCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String petNameString = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_PET_NAME));
        String petBreedString = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_PET_BREED));
        // Populate fields with extracted properties
        petNameTextView.setText(petNameString);
        petBreedTextView.setText(petBreedString);
    }
}